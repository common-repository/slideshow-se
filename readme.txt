...
1. Here's what a default slideshow can look like. This one uses a custom stylesheet.
...
8. Custom styles can be added and modified here. Custom styles can be used to style one or more slideshows to your own personal taste.
